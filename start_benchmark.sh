...
AERYS2_COMMAND="./aerys2/vendor/bin/aerys -w 1 -c ./aerys2/server.php"
...
start_benchmark "Benchmarking Aerys v2 (keep-alive + OPCache)" "${PHP_COMMAND} -c ./php/default-opcache.ini ${AERYS2_COMMAND}"
